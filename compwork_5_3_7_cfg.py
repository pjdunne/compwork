...
options.register ('nevents',
                  ...
                  VarParsing.VarParsing.multiplicity.singleton, # singleton or list
                  VarParsing.VarParsing.varType.int,          # string, int, or float
                  "Process how many events?")

options.register ('filetoproc',
                  'MyOutputFile.root', # default value
                  VarParsing.VarParsing.multiplicity.singleton, # singleton or list
                  VarParsing.VarParsing.varType.string,          # string, int, or float
                  "File to Process")
...
if nevents:
  print 'Processing ' + str(nevents) + ' events'

if filetoproc:
  print 'from file ' + filetoproc
  ...
  if isData:
    ...
    process.source = cms.Source(
      ...
      fileNames = cms.untracked.vstring(
        ...
        'file:'+filetoproc,#/afs/cern.ch/work/p/pdunne/public/VBF_HToTauTau_M-125-53X.root'
        'file:'+filetoproc,
        'file:'+filetoproc,
        'file:'+filetoproc,
        'file:'+filetoproc,
